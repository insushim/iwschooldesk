...
contextBridge.exposeInMainWorld('api', {
  ...
  timetable: {
    ...
    getOverridesRange: (startDate: string, endDate: string) => ipcRenderer.invoke('timetable:getOverridesRange', startDate, endDate),
  ...
  widget: {
    ...
    resetPositions: () => ipcRenderer.invoke('widget:resetPositions'),
